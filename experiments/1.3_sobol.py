...
arg_parser.add_argument(
    ...
    #metavar='parallel_buffer_size_si_computing',
    type=int,
    default=1000,
...
print(model_dirname, model_filename, num_classes)
...
if do_compute_values:
    ...
    si_fnm = f'{values_fnm_prefix}_{fnm_suffix}.hdf5'
    si_path = os.path.join(activations_dirname, si_fnm)

    si_path = sensitivity_analysis.sobol.analyze_transform_with_sobol(
        problem,
        ...
        verbose=True,
        rewrite_hdf5=True,
        tmp_save_path=f'../results/tmp/1.3/{augmentation_set_number}/',
    )

    print(f'Please find the computed results in file: {si_path}')
